...
VL_ATTR_COLD void Vsinegen___024root__trace_init_sub__TOP__0(Vsinegen___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"phase_diff", false,-1, 7,0);
    ...
    tracep->declBus(c+11,"rom_data", false,-1, 7,0);
...
VL_ATTR_COLD void Vsinegen___024root__trace_full_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->phase_diff),8);
    ...
    bufp->fullCData(oldp+9,((0xffU & ((IData)(vlSelf->sinegen__DOT__address1) 
                                      + (IData)(vlSelf->phase_diff)))),8);
    bufp->fullIData(oldp+10,(8U),32);
    bufp->fullCData(oldp+11,(vlSelf->sinegen__DOT__rom_data),8);
}
